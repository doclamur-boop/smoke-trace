'use strict';
const VERSION='smoke-trace-v19.4';
const CORE=['./','./index.html','./styles.css?v=19.4','./db.js?v=19.4','./charts.js?v=19.4','./app.js?v=19.4','./manifest.webmanifest','./icon-v19-192.png','./icon-v19-512.png'];
