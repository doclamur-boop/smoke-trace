'use strict';
const VERSION='smoke-trace-v19.5';
const CORE=['./','./index.html','./styles.css?v=19.5','./db.js?v=19.5','./charts.js?v=19.5','./app.js?v=19.5','./manifest.webmanifest','./icon-v19-192.png','./icon-v19-512.png'];
