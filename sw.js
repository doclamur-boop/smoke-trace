'use strict';
const VERSION='smoke-trace-v19.6';
const CORE=['./','./index.html','./styles.css?v=19.6','./db.js?v=19.6','./charts.js?v=19.6','./app.js?v=19.6','./manifest.webmanifest','./icon-v19-192.png','./icon-v19-512.png'];
