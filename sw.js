'use strict';
const VERSION='smoke-trace-v19.10';
const CORE=['./','./index.html','./styles.css?v=19.10','./db.js?v=19.10','./charts.js?v=19.10','./app.js?v=19.10','./manifest.webmanifest','./icon-v19-192.png','./icon-v19-512.png'];
