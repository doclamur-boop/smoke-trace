'use strict';
const VERSION='smoke-trace-v19.7';
const CORE=['./','./index.html','./styles.css?v=19.7','./db.js?v=19.7','./charts.js?v=19.7','./app.js?v=19.7','./manifest.webmanifest','./icon-v19-192.png','./icon-v19-512.png'];
