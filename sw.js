'use strict';
const VERSION='smoke-trace-v19.8';
const CORE=['./','./index.html','./styles.css?v=19.8','./db.js?v=19.8','./charts.js?v=19.8','./app.js?v=19.8','./manifest.webmanifest','./icon-v19-192.png','./icon-v19-512.png'];
