'use strict';
const VERSION='smoke-trace-v19.2';
const CORE=['./','./index.html','./styles.css?v=19','./db.js?v=19','./charts.js?v=19','./app.js?v=19','./interaction.js?v=19','./manifest.webmanifest','./icon-v19.svg'];
