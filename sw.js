'use strict';
const VERSION='smoke-trace-v19.9';
const CORE=['./','./index.html','./styles.css?v=19.9','./db.js?v=19.9','./charts.js?v=19.9','./app.js?v=19.9','./manifest.webmanifest','./icon-v19-192.png','./icon-v19-512.png'];
